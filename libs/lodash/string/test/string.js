        ...
        , function () {
            ...
            it( 'template'
              , function () {
                  ...
                  compile = _.template( '<%= up( name ) %>'
                                      , { imports : { up : _.toUpper } }
                                      )
                  compile( { name : 'Pwn' } ).should.equal( 'PWN' )

                  // variable
                  // 禁止 with 语句
                  compile = _.template( '<%= data.name %>'
                                      , { variable : 'data' }
                                      )
                  compile( { name : 'Pwn' } ).should.equal( 'Pwn' )
            ...
            it( 'upperCase , lowerCase , camelCase , startCase , snakeCase , kebabCase'
              , function () {
