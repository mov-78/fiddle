...
describe( 'lodash/collection'
        , function () {
            ...
            it( 'each|forEach , eachRight|forEachRight'
              , function () {
            ...
            it( 'filter , reject'
              , function () {
                  ...
                  //    - filter：返回数组 - 忽略对象结构
                  _.filter( { foo : 1 , bar : 2 }
                          , ( value , key , object ) => value % 2 === 0
                          )
                    .should.be.an( 'array' )
                    .that.is.deep.equal( [ 2 ] )
                  _.reject( { foo : 1 , bar : 2 }
                          , ( value , key , object ) => value % 2 === 0
                          )
                    .should.be.an( 'array' )
