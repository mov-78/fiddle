...
describe( 'lodash/object'
        , function () {
            ...
            it( 'assign , assignIn|extend , assignWith , assignInWith|extendWith'
              , function () {
            ...
            it( 'keys , keysIn , functions , functionsIn , values , valuesIn'
              , function () {

                  let obj = _.create( { foo() {} }
                                    , { bar() {}
                                      , baz : null
                                      }
                                    )
            ...
            it( 'forIn , forInRight , forOwn , forOwnRight'
              , function () {
            ...
            it( 'findKey , findLastKey'
              , function () {

                  _.findKey( { foo : 'qux' , bar : 'qux' }
                           , ( value , key , object ) => value === 'qux'
                           )
                    .should.equal( 'foo' )

                  _.findLastKey( { foo : 'qux' , bar : 'qux' }
                               , ( value , key , object ) => value === 'qux'
                               )
                    .should.equal( 'bar' )
            ...
            it( 'pick , pickBy , omit , omitBy'
              , function () {

                  const obj = { foo : 1 , bar : 2 }
                      , predicate = ( value , key ) => value % 2 === 0
