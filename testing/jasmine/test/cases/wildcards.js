...
describe( 'jasmine.anything'
        , function () {
            it( 'matches any thing except for null and undefined'
              , function () {
        ...
        , function () {
            ...
            it( 'matches objects with the expected key/value pairs'
              , function () {
                  ...
                  expect( this.foobar )
                    .toEqual( jasmine.objectContaining( { foo : 1 } ) )
                  expect( this.foobar )
                    .toEqual( jasmine.objectContaining( { bar : 2 } ) )

                  expect( this.foobar )
                    .not.toEqual( jasmine.objectContaining( { foo : 2 } ) )
                  expect( this.foobar )
                    .not.toEqual( jasmine.objectContaining( { baz : 3 } ) )
