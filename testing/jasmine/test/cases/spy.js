...
describe( 'A spy'
        , function () {
            ...
            it( 'by default skip the actual implementation'
              , function () {
...
describe( 'A spy,'
        , function () {
            ...
            describe( 'when configured to fake a return value'
                    , function () {
            ...
            describe( 'when configured to fake a series of return values'
                    , function () {
...
describe( 'A spy'
        , function () {
            ...
            // calls.argsFor( index )
            it( 'trakcs the arguments of each call'
              , function () {
            ...
            // calls.allArgs()
            it( 'trakcs the arguments of all calls'
              , function () {
            ...
            // calls.first()
            // calls.mostRecent()
            it( 'tracks the arguments, return value and context of all calls'
              , function () {
