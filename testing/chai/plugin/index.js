...
chai
  .use( function ( _chai , utils ) {
          ...
          chai.Assertion
            .addProperty( 'prop'
                        , function () {
                            ...
                            this.assert( negate ? false : true // [1] 表达式
          ...
          chai.Assertion
            .addChainableMethod( 'chainableMethod'
                               , function method(/* params */) {}
                               , function chainingBehavior() {}
                               )

          expect( chai.Assertion.prototype )
            .to.have.ownProperty( 'chainableMethod' )
